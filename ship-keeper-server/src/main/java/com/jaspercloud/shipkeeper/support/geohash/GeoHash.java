...
public final class GeoHash implements Comparable<GeoHash>, Serializable {
    ...
    public static GeoHash withCharacterPrecision(WGS84Point wgs84Point, int numberOfCharacters) {
        GeoHash geoHash = withCharacterPrecision(wgs84Point.getLatitude(), wgs84Point.getLongitude(), numberOfCharacters);
        return geoHash;
    }
    ...
    public static GeoHash withBitPrecision(WGS84Point wgs84Point, int numberOfBits) {
        GeoHash geoHash = withBitPrecision(wgs84Point.getLatitude(), wgs84Point.getLongitude(), numberOfBits);
        return geoHash;
    }
    ...
    public List<GeoHash> getAdjacentList() {
        List<GeoHash> geoHashList = Arrays.asList(getAdjacent());
        return geoHashList;
    }
